...
import { AdminRequestDetailsSkeleton } from "@/components/skeletons/AdminRequestDetailsSkeleton";
import { Skeleton } from "@/components/ui/skeleton";
import { useAdminRequest } from "./hooks/useAdminRequest";
import { useRequestPrompt } from "./hooks/useRequestPrompt";
import { useFormattedDate } from "@/hooks/formatting/useFormattedDate";
import { useSignedImageUrls } from "../../history/hooks/useSignedImageUrls";
                          ...
                          <CardContent>
                            <div className="grid gap-4 sm:grid-cols-2">
                              <div>
                                ...
                                {request.user?.id && (
                                  <p className="text-xs text-muted-foreground font-mono mt-1">ID: {request.user.id}</p>
                                )}
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">{adviceName || 'N/A'}</p>
                              </div>
                              {request.rating && (
                                <div>
