    ...
    <BannerContext.Provider value={{ show, setShow }}>
      <div
        className={cn(
          ...
          'bg-slate-100 text-slate-800 dark:bg-primary dark:text-primary-foreground',
          inset && 'rounded-lg',
          className
        )}
        {...props}
...
export const BannerIcon = ({
  ...
  <div
    className={cn(
      'rounded-full border border-slate-300 bg-slate-200 p-1 shadow-sm',
      'dark:border-background/20 dark:bg-background/10',
      className
    )}
    {...props}
  >
...
export const BannerAction = ({
  ...
  <Button
    className={cn(
      'shrink-0 bg-transparent hover:bg-slate-200 hover:text-slate-800',
      'dark:hover:bg-background/10 dark:hover:text-background',
      className
    )}
    size={size}
    variant={variant}
