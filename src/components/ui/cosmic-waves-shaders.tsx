...
void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
  ...
  gradient += pattern;
  // Color cycling through yellow/golden spectrum
  vec3 color1 = vec3(0.8, 0.6, 0.1); // Golden yellow
  vec3 color2 = vec3(0.9, 0.7, 0.2); // Bright gold
  vec3 color3 = vec3(0.9, 0.8, 0.3); // Light yellow
  vec3 color4 = vec3(0.7, 0.5, 0.1); // Dark gold
  ...
  finalColor += glow * vec3(0.9, 0.7, 0.2);
  // Vignette effect
